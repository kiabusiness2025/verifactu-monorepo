...
[ ] Headers de seguridad en ambos proyectos incluyen: - `Access-Control-Allow-Credentials: true` (si cross-origin) - Cookies con `SameSite=Lax` o `Lax` - `Domain: .verifactu.business` para compartir entre subdominios
