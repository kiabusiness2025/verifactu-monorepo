...
export async function POST(req: Request) {
  ...
  `,
    [tenantId, `Demo SL - ${firstName}`, 'EMPRESA DEMO SOCIEDAD LIMITADA', 'B99999999', true]
  );
...
```html
<button>📹 Solicitar Demo Personalizada</button>

<!-- Modal después de click -->
<h3>Queremos conocerte mejor</h3>
<p>Cuéntanos sobre tu empresa y te mostraremos cómo Verifactu puede ayudarte.</p>
...
```html
<button>🚀 Probar Gratis 14 Días</button>
...
<p class="legal">Al registrarte, aceptas nuestros términos de servicio</p>
```
