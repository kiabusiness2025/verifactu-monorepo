...
- [product/holded/HOLDED_CONNECTORS_PUBLIC_ARCHITECTURE_PLAN_2026-04-25.md](product/holded/HOLDED_CONNECTORS_PUBLIC_ARCHITECTURE_PLAN_2026-04-25.md) - Plan aprobado para landings por conector, hub futuro de `holded.verifactu.business` e Isaak Fase II
...
- [product/holded/HOLDED_CONNECTORS_PUBLIC_ARCHITECTURE_PLAN_2026-04-25.md](product/holded/HOLDED_CONNECTORS_PUBLIC_ARCHITECTURE_PLAN_2026-04-25.md) - Roadmap de URLs publicas: raiz como hub despues de OpenAI, paths por conector y encaje de Isaak
