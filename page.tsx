  ...
  const isaakMessages: IsaakMsg[] = useMemo(
    () => [
      ...
      },
      {
        ...
        body: "Factura VF-2031 creada y validada. ┬┐La env├áo al cliente o la programo para ma├▒ana?",
      },
      {
        type: "ok",
    ...
    <div className="min-h-screen bg-white text-slate-900">
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            >
              ...
              <p className="mt-3 max-w-xl text-sm text-slate-500">
                Cumple con Verifactu y normativa fiscal espa├▒ola desde el primer d├áa.
              </p>
              ...
              <p className="mt-4 text-xs text-slate-500">
                Sin tarjeta ┬· 30 d├áas gratis en planes de pago ┬· Puedes cancelar cuando quieras
              </p>
            </motion.div>
        ...
        <Container>
          <div className="text-center">
            ...
            <p className="mt-3 max-w-2xl mx-auto text-sm leading-6 text-slate-600 sm:text-base">
              Segmentamos el acompa├▒amiento seg├║n tu perfil: foco en simplicidad para aut├│nomos, control para pymes y orden fiscal para gestor├áas.
            </p>
          </div>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">Dashboard con ventas, gastos y beneficio real. Roles por equipo y evidencias listas para auditor├áa.</p>
            </div>

            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              <div className="inline-flex items-center gap-2 rounded-full bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-800 ring-1 ring-blue-100"><Briefcase className="h-4 w-4" />Gestor├áas</div>
        ...
        <Container>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <FeatureCard
              ...
              bullets={["Foto del ticket  clasificado", "Deducible seg├║n tu actividad", "Apunte registrado al instante"]}
            />
            <FeatureCard
            ...
            <FeatureCard
              ...
              bullets={["Informes y exportaciones", "Listados por cliente, per├áodo", "An├ílisis profundo cuando lo necesites"]}
            />
          </div>
        </Container>
      </section>
        ...
        <Container>
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-3">
            ...
            <CommandExample
              ...
              response="Listo. Gastos T4 2025: 8.200 €¼ en total. He agrupado por categor├áa (alimentaci├│n, transporte, oficina). ┬┐Lo exporto a Excel o PDF?"
            />
            <CommandExample
              command="Dame el ranking de clientes por facturaci├│n"
              response="Top 5 clientes este a├▒o: L├│pez S.L. (18.500 €¼), Acme Corp (15.200 €¼), Tech Solutions (12.100 €¼). ┬┐Quieres ver m├írgenes o proyecciones?"
            />
            <CommandExample
            ...
            <CommandExample
              ...
              response="Archivo generado: 234 productos, con c├│digos, precios, categor├áas y stock. Descargable en 2 segundos. ┬┐Necesitas filtros especiales?"
            />
            <CommandExample
      ...
      <section className="py-16 bg-gradient-to-b from-blue-50 via-blue-100 to-white">
        <Container>
          <h3 className="text-center text-2xl font-semibold tracking-tight sm:text-3xl">
            Del env├áo al cobro en tres pasos.
          </h3>
      ...
      <section className="py-16">
        <Container>
          ...
          <p className="mx-auto mt-3 max-w-2xl text-center text-sm leading-6 text-slate-600 sm:text-base">
            Isaak compara tu hist├│rico, detecta anomal├áas y propone acciones. T├║ solo ves: ventas, gastos y beneficio.
          </p>
            ...
            <div className="rounded-3xl bg-gradient-to-b from-blue-50 via-blue-100 to-white p-6 shadow-sm ring-1 ring-slate-200">
              ...
              <div className="mt-6 space-y-3">
                <InfoPill
                  ...
                  desc="Gratis o 30 d├áas de prueba. Cuota fija y sin sorpresas ni variables sobre facturaci├│n."
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                <PrimaryButton className="w-full sm:w-auto">
                  Probar gratis 30 d├áas <ChevronRight className="h-4 w-4" />
                </PrimaryButton>
      ...
      >
        <Container className="py-16">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-slate-600 sm:text-lg">
              <strong>Todos los planes incluyen:</strong> Acceso permanente a tus datos ┬· Prueba gratuita de 30 d├áas ┬· Posibilidad de cambiar o pausar sin perder informaci├│n
            </p>
          </div>
      ...
      <section className="py-14 bg-gradient-to-b from-blue-50 via-blue-100 to-white">
        <Container>
          ...
          <p className="mx-auto mt-3 max-w-2xl text-center text-sm leading-6 text-slate-600 sm:text-base">
            Gu├áas, onboarding y checklist para aplicar mejores pr├ícticas y aprovechar todo el potencial de la plataforma.
          </p>
      ...
      <section className="py-12 bg-gradient-to-b from-blue-50 via-blue-100 to-white">
        <Container>
          <div className="text-center">
            <p className="text-sm font-semibold text-emerald-700">La garant├áa que buscabas</p>
        ...
        <Container>
          <div className="flex flex-col items-center justify-between gap-4 rounded-3xl border border-slate-200 bg-gradient-to-r from-blue-50 via-blue-100 to-white p-6 shadow-sm sm:flex-row">
            ...
            <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row">
              ...
              <SecondaryButton className="w-full sm:w-auto">Empezar gratis 30 d├áas</SecondaryButton>
            </div>
          </div>
        </Container>
      </section>
...
function HeroMockup({ visibleMsgs, benefitValue }: { visibleMsgs: IsaakMsg[]; benefitValue: number }) {
  ...
  const heroLog = [
    ...
    { title: "Sync VeriFactu", desc: "├Última validaci├│n hace 3 min" },
  ];
      ...
      <div className="mt-4 grid gap-3 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4">
          ...
          <div className="mt-3 space-y-2">
            ...
            <ActivityItem icon={<CalendarClock className="h-4 w-4 text-blue-600" />} text="Recordatorio creado: plazo fiscal en 5 d├áas" />
    ...
    >
      ...
      <div className="mt-4 border-t border-slate-100 pt-3">
        <p className="text-center text-[11px] text-slate-500">
          {isPrimary ? "30 d├áas gratis incluidos" : "Gratis o prueba seg├║n plan"}
        </p>
    ...
    <footer className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-slate-100">
      ...
      <Container className="py-12 relative z-10">
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <FooterCol
            title="Recursos"
            links={["Gu├áas y webinars", "Checklist", "Blog", "Contacto"]}
          />
          <FooterCol
            title="Legal"
            links={["VeriFactu", "Pol├ática de privacidad", "T├®rminos de servicio", "Cookies"]}
          />
        </div>
        ...
        <div className="mt-10 border-t border-white/10 pt-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-slate-400">
            ...
            <div className="flex gap-6">
              ...
              <a href="/legal/privacidad" className="hover:text-blue-300 transition">Pol├ática de privacidad</a>
