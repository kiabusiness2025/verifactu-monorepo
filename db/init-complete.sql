...
INSERT INTO plans (code, name, fixed_monthly, variable_rate, max_invoices_per_month, max_revenue_per_month) VALUES
('freelance', 'Freelance', 0, 0.010, 20, 6000.00),
('starter', 'Starter', 19.00, 0.005, 50, 15000.00),
('pro', 'Pro', 49.00, 0.003, 200, 50000.00),
('business', 'Business', 99.00, 0.002, NULL, NULL),
('enterprise', 'Enterprise', 299.00, 0.001, NULL, NULL)
ON CONFLICT (code) DO NOTHING;

-- Categorías de gastos básicas
INSERT INTO expense_categories (code, name, is_deductible) VALUES
('office', 'Oficina y suministros', true),
('software', 'Software y herramientas', true),
('marketing', 'Marketing y publicidad', true),
('travel', 'Viajes y desplazamientos', true),
('professional', 'Servicios profesionales', true),
('insurance', 'Seguros', true),
('taxes', 'Impuestos y tasas', true),
('banking', 'Gastos bancarios', true),
('training', 'Formación', true),
('other', 'Otros gastos', true)
ON CONFLICT (code) DO NOTHING;
