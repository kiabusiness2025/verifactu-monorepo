import { LayoutDashboard, FileText, Building2, CreditCard, Settings, Bot, Receipt } from "lucide-react";
...
export const navClient: NavTemplate[] = [
  ...
  { label: "Gastos", href: "/t/:tenantSlug/erp/expenses", icon: <Receipt className="h-4 w-4" /> },
