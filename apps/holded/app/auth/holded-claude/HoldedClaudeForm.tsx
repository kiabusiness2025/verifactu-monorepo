...
export function HoldedClaudeForm({ sessionEmail }: { sessionEmail: string | null }) {
  ...
  async function handleStep2Submit(e: FormEvent) {
    ...
    try {
      const res = await fetch('/api/auth/holded-claude', {
        method: 'POST',
            ...
            <div className="px-6 pb-7 pt-7 sm:px-8">
              ...
              <div className="text-center">
                <div className="inline-flex items-center gap-3 rounded-full border border-slate-200 bg-white px-4 py-2 shadow-sm">
                  <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#fffbeb] ring-1 ring-amber-200">
                    <Image
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-xs text-slate-500">Conexión Holded para Claude</div>
                  </div>
                  <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#fffbeb] ring-1 ring-amber-200">
                    <Image
                ...
                {authPhase === 'consuming' ? (
                  ...
                  <>
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-500">
                      Identifícate para conectar Holded con Claude.
                    </p>
                  </>
                ) : (
                  <>
                  ...
                  <form onSubmit={handleMagicLinkSubmit} className="space-y-3">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="block h-12 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-900 placeholder:text-slate-400 focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/30"
                      />
                    </div>
                    <button
                      type="submit"
                ...
                <>
                  ...
                  <form onSubmit={handleStep2Submit} className="mt-6 space-y-4">
                      ...
                      <div
                        className={`relative rounded-2xl border bg-white shadow-sm transition focus-within:shadow-md ${
                          showApiKeyFormatError
                            ...
                            : 'border-slate-200 focus-within:border-amber-500 focus-within:ring-2 focus-within:ring-amber-500/30'
                        }`}
                      >
                        <input
                    ...
                    >
                      ...
                      {step2Loading ? 'Conectando…' : 'Conectar Holded a Claude'}
                    </button>
              ...
              {!isApiKeyStep ? (
                <ul className="mt-5 space-y-2 text-xs text-slate-500">
                  <li className="flex items-start gap-2">
                    <ShieldCheck className="mt-0.5 h-3.5 w-3.5 text-amber-600" />
