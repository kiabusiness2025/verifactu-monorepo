  ...
  return (
    <ConnectorPageShell provider="claude" kind="terms">
      <ConnectorPageHero
        ...
        subtitle="Conector Holded para Claude"
        intro={
          <>
            Estos términos regulan el acceso y uso del <strong>Conector Holded para Claude</strong>,
      ...
      <div className="mt-10 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-4 grid gap-2 sm:grid-cols-3">
          {[
            ...
            <div key={label} className="rounded-2xl border border-amber-100 bg-amber-50 px-4 py-3">
      ...
      <div className="mt-6 rounded-3xl border border-amber-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-3">
          <div className="rounded-2xl border border-slate-100 bg-slate-50 p-4">
            ...
            <p className="mt-2 text-xs leading-6 text-slate-600">
              ...
              las respuestas son responsabilidad de Anthropic conforme a sus propios términos.
            </p>
          </div>
          <div className="rounded-2xl border border-slate-100 bg-slate-50 p-4">
            <div className="text-[10px] font-semibold uppercase tracking-widest text-amber-700">
          ...
          <div className="rounded-2xl border border-amber-100 bg-amber-50 p-4">
            ...
            <p className="mt-2 text-xs leading-6 text-slate-700">
              Provee la infraestructura MCP que traduce peticiones de Claude a llamadas a la API de
        ...
        <p className="mt-4 text-xs leading-6 text-slate-500">
          ...
          el contenido de las respuestas de Claude, por la disponibilidad o exactitud de los datos
      ...
      <div className="mt-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-3 text-sm leading-7 text-slate-600">
          El conector permite a los usuarios de Claude acceder a datos clave de su cuenta de Holded:
          facturas, contactos, cuentas contables, diario, productos, proyectos, equipo y CRM. La
          conexión utiliza el protocolo MCP con autenticación OAuth 2.0 + PKCE + DCR. Las
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2">
        <article className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <ul className="mt-3 space-y-2 text-sm leading-7 text-slate-600">
            ...
            <li>
              Debes revisar y confirmar cualquier acción que modifique datos antes de ejecutarla en
              Holded.
            </li>
            <li>
        ...
        <article className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <ul className="mt-3 space-y-2 text-sm leading-7 text-slate-600">
            <li>
              Verifactu Business <strong>no genera</strong> las respuestas de Claude ni controla su
              contenido. Las decisiones basadas en dichas respuestas son responsabilidad exclusiva
              del usuario.
            </li>
            <li>
