      ...
      <section className="mx-auto max-w-5xl px-4 py-16">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-slate-950">
              DPA del Conector Holded para Claude
            </h1>
            <p className="max-w-3xl text-lg leading-8 text-slate-600">
              Este acuerdo describe el tratamiento de datos personales y de negocio cuando el
              usuario conecta Holded con Claude mediante el servidor MCP operado por Verifactu
              Business.
            </p>
        ...
        <article className="mt-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-500">
            La lista puede actualizarse cuando cambie la infraestructura o el proveedor de
            servicios.
          </p>
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <LegalCard icon={Clock} title="Conservacion">
            <p>
              Los tokens tecnicos se conservan durante el tiempo necesario para operar la sesion y
              la conexion. Los datos de cuenta y conexion se conservan mientras el usuario mantiene
              el servicio activo o hasta que solicite la eliminacion o desconexion. Los logs
              operativos se limitan a seguridad, soporte y trazabilidad tecnica.
            </p>
          </LegalCard>
