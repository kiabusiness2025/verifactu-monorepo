// C-B3+ — Exporta el borrador 111 como fichero .111 BOE.

import { NextRequest, NextResponse } from 'next/server';
import { getHoldedSession } from '@/app/lib/holded-session';
import { compute111ForTenant } from '@/app/lib/isaak-modelo-111-repo';
import { serialize111, type Modelo111Context } from '@/app/lib/aeat-formats/111/serializer';
