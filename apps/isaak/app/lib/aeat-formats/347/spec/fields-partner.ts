// Auto-generated from fields-partner.xml.
// Source: github.com/OCA/l10n-spain (AGPL/LGPL).

export const SPEC_347_PARTNER_XML: string = `<?xml version="1.0" encoding="utf-8" ?>
<odoo>
    <!-- Tipo de Registro 2 – Registro de declarado: -->
    <record id="aeat_mod347_partner_export_config" model="aeat.model.export.config">
        <field
            name="name"
        >Exportación modelo 347 - Tipo de Registro 2 – Registro de declarado</field>
        <field name="model_number">347</field>
    </record>
    <!--             1           Tipo de Registro -->
    <record
        id="aeat_mod347_partner_export_line_01"
    ...
    <record
        id="aeat_mod347_partner_export_line_02"
        model="aeat.model.export.config.line"
    >
    ...
    <!--             5-8         Ejercicio -->
    <record
        id="aeat_mod347_partner_export_line_03"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod347_partner_export_line_04"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod347_partner_export_line_05"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod347_partner_export_line_06"
        model="aeat.model.export.config.line"
    >
    ...
    <!--                         declarado -->
    <record
        id="aeat_mod347_partner_export_line_07"
        model="aeat.model.export.config.line"
    >
    ...
    <!--             76          Tipo de hoja -->
    <record
        id="aeat_mod347_partner_export_line_08"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod347_partner_export_line_09"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod347_partner_export_line_10"
        model="aeat.model.export.config.line"
    >
        ...
        <field
            name="expression"
        >\${object.partner_country_code if object.partner_state_code == '99' else ''}</field>
        <field name="export_type">string</field>
        <field name="size">2</field>
        <field name="alignment">left</field>
    </record>
    <!--             81          Blancos -->
    <record
        id="aeat_mod347_partner_export_line_11"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod347_partner_export_line_12"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod347_partner_export_line_13"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod347_partner_export_line_16"
        model="aeat.model.export.config.line"
    >
    ...
    <!--                         sujetas a IVA -->
    <record
        id="aeat_mod347_partner_export_line_17"
        model="aeat.model.export.config.line"
    >
        ...
        <field
            name="name"
        >Importe percibido por transmisiones de inmuebles sujetas a IVA</field>
    ...
    <record
        id="aeat_mod347_partner_export_line_18"
        model="aeat.model.export.config.line"
    >
        ...
        <field
            name="expression"
        >\${object.origin_year or object.report_id.year if object.cash_amount else '0000'}</field>
        <field name="export_type">string</field>
        <field name="size">4</field>
        <field name="alignment">left</field>
    </record>
    ...
    <record
        id="aeat_mod347_partner_export_line_19"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod347_partner_export_line_20"
        model="aeat.model.export.config.line"
    >
        ...
        <field
            name="name"
        >Importe percibido por transmisiones de inmuebles sujetas a Iva Primer Trimestre</field>
        <field
            name="expression"
    ...
    <record
        id="aeat_mod347_partner_export_line_21"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod347_partner_export_line_22"
        model="aeat.model.export.config.line"
    >
        ...
        <field
            name="name"
        >Importe percibido por transmisiones de inmuebles sujates a Iva Segundo Trimestre</field>
        <field
            name="expression"
    ...
    <record
        id="aeat_mod347_partner_export_line_23"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod347_partner_export_line_24"
        model="aeat.model.export.config.line"
    >
        ...
        <field
            name="name"
        >Importe percibido por transmisiones de inmuebles sujates a Iva Tercero Trimestre</field>
        <field
            name="expression"
    ...
    <record
        id="aeat_mod347_partner_export_line_25"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod347_partner_export_line_26"
        model="aeat.model.export.config.line"
    >
        ...
        <field
            name="name"
        >Importe percibido por transmisiones de inmuebles sujates a Iva Cuarto Trimestre</field>
        <field
            name="expression"
    ...
    <record id="aeat_mod349_main_export_line_30" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Operaciones vinculadas al régimen de depósito distinto del aduanero</field>
