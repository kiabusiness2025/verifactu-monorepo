...
export const SPEC_347_MAIN_XML: string = `<?xml version="1.0" encoding="utf-8" ?>
<odoo>
    ...
    <record id="aeat_mod347_main_export_config" model="aeat.model.export.config">
        ...
        <field
            name="model_id"
            ref="l10n_es_aeat_mod347.model_l10n_es_aeat_mod347_report"
        />
    ...
    <record id="aeat_mod347_main_export_line_10" model="aeat.model.export.config.line">
        ...
        <field
            name="expression"
        >\${' S' if object.statement_type == 'S' else object.statement_type.replace('N', ' ')}</field>
        <field name="export_type">string</field>
