// Auto-generated from fields.xml.
// Source: github.com/OCA/l10n-spain (AGPL/LGPL).

export const SPEC_111_XML: string = `<?xml version="1.0" encoding="utf-8" ?>
...
<odoo>
    ...
    <record id="aeat_mod111_sub01_export_config" model="aeat.model.export.config">
        <field name="name">Mod.111 2016 - Página</field>
    ...
    <record id="aeat_mod111_sub01_export_line_12" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Rendimientos del trabajo - Rendimientos dinerarios - Número de perceptores [01]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_13" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Rendimientos del trabajo - Rendimientos dinerarios - Importe de las percepciones [02]</field>
        <field
            name="expression"
    ...
    <record id="aeat_mod111_sub01_export_line_14" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Rendimientos del trabajo - Rendimientos dinerarios - Importe de las retenciones [03]</field>
        <field
            name="expression"
    ...
    <record id="aeat_mod111_sub01_export_line_15" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Rendimientos del trabajo - Rendimientos en especie - Número de perceptores [04]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_16" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Rendimientos del trabajo - Rendimientos en especie - Importe de las percepciones [05]</field>
        <field
            name="expression"
        >\${object.tax_line_ids.filtered(lambda r: r.field_number==5).amount}</field>
        <field name="export_type">float</field>
        <field name="apply_sign" eval="True" />
        <field name="size">17</field>
        <field name="decimal_size">2</field>
    ...
    <record id="aeat_mod111_sub01_export_line_17" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Rendimientos del trabajo - Rendimientos en especie - Importe de las retenciones [06]</field>
        <field
            name="expression"
        >\${object.tax_line_ids.filtered(lambda r: r.field_number==6).amount}</field>
        <field name="export_type">float</field>
        <field name="apply_sign" eval="True" />
        <field name="size">17</field>
        <field name="decimal_size">2</field>
    ...
    <record id="aeat_mod111_sub01_export_line_18" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Rendimientos de actividades económicas - Rendimientos dinerarios - Número de perceptores [07]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_19" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Rendimientos de actividades económicas - Rendimientos dinerarios - Importe de las percepciones [08]</field>
        <field
            name="expression"
        >\${object.tax_line_ids.filtered(lambda r: r.field_number==8).amount}</field>
        <field name="export_type">float</field>
        <field name="apply_sign" eval="True" />
        <field name="size">17</field>
        <field name="decimal_size">2</field>
    ...
    <record id="aeat_mod111_sub01_export_line_20" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Rendimientos de actividades económicas - Rendimientos dinerarios - Importe de las retenciones [09]</field>
        <field
            name="expression"
        >\${object.tax_line_ids.filtered(lambda r: r.field_number==9).amount}</field>
        <field name="export_type">float</field>
        <field name="apply_sign" eval="True" />
        <field name="size">17</field>
        <field name="decimal_size">2</field>
    ...
    <record id="aeat_mod111_sub01_export_line_21" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Rendimientos de actividades económicas - Rendimientos en especie - Número de perceptores [10]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_22" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Rendimientos de actividades económicas - Rendimientos en especie - Importe de las percepciones [11]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_23" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Rendimientos de actividades económicas - Rendimientos en especie - Importe de las retenciones [12]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_24" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Premios por la participación en juegos, concursos, rifas o combinaciones aleatorias - Rendimientos dinerarios - Número de perceptores [13]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_25" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Premios por la participación en juegos, concursos, rifas o combinaciones aleatorias - Rendimientos dinerarios - Importe de las percepciones [14]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_26" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Premios por la participación en juegos, concursos, rifas o combinaciones aleatorias - Rendimientos dinerarios - Importe de las retenciones [15]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_27" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Premios por la participación en juegos, concursos, rifas o combinaciones aleatorias - Rendimientos en especie - Número de perceptores [16]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_28" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Premios por la participación en juegos, concursos, rifas o combinaciones aleatorias - Rendimientos en especie - Importe de las percepciones [17]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_29" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Premios por la participación en juegos, concursos, rifas o combinaciones aleatorias - Rendimientos en especie - Importe de las retenciones [18]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_30" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Ganancias patrimoniales derivadas de los aprovechamientos forestales de los vecinos en los montes públicos - Rendimientos dinerarios - Número de perceptores [19]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_31" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Ganancias patrimoniales derivadas de los aprovechamientos forestales de los vecinos en los montes públicos - Rendimientos dinerarios - Importe de las percepciones [20]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_32" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Ganancias patrimoniales derivadas de los aprovechamientos forestales de los vecinos en los montes públicos - Rendimientos dinerarios - Importe de las retenciones [21]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_33" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Ganancias patrimoniales derivadas de los aprovechamientos forestales de los vecinos en los montes públicos - Rendimientos en especie - Número de perceptores [22]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_34" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Ganancias patrimoniales derivadas de los aprovechamientos forestales de los vecinos en los montes públicos - Rendimientos en especie - Importe de las percepciones [23]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_35" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Ganancias patrimoniales derivadas de los aprovechamientos forestales de los vecinos en los montes públicos - Rendimientos en especie - Importe de las retenciones [24]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_36" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Contraprestaciones por la cesión de derechos de imagen, ingresos a cuenta previstos en el artículo 92.8 de la Ley del Impuesto - Contrapartidas dinerarias o en especie - Número de perceptores [25]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_37" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Contraprestaciones por la cesión de derechos de imagen, ingresos a cuenta previstos en el artículo 92.8 de la Ley del Impuesto - Contrapartidas dinerarias o en especie - Contraprestaciones satisfechas [26]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_38" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Contraprestaciones por la cesión de derechos de imagen, ingresos a cuenta previstos en el artículo 92.8 de la Ley del Impuesto - Contrapartidas dinerarias o en especie - Importe de los ingresos a cuenta [27]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_39" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Total liquidación - Suma de las retenciones e ingresos a cuenta [28]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_40" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Total liquidación - Resultado a ingresar de la anterior o anteriores autoliquidaciones por el mismo concepto, ejercicio y período [29]</field>
    ...
    <record id="aeat_mod111_sub01_export_line_44" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Administración presentando declaración de Colegio Concertado (CC)</field>
    ...
    <record id="aeat_mod111_main_export_config" model="aeat.model.export.config">
        <field name="name">Mod.111 2016-actualidad</field>
        <field name="date_start">2016-01-01</field>
        <field name="model_number">111</field>
        <field
            name="model_id"
            ref="l10n_es_aeat_mod111.model_l10n_es_aeat_mod111_report"
        />
    </record>
    ...
    <record id="aeat_mod111_main_export_line_14" model="aeat.model.export.config.line">
        ...
        <field name="subconfig_id" ref="aeat_mod111_sub01_export_config" />
    ...
    <record id="aeat_mod111_main_export_line_15" model="aeat.model.export.config.line">
        ...
        <field
            name="expression"
        >&lt;/T1110\${object.year}\${object.period_type}0000&gt;</field>
        <field name="export_type">string</field>
