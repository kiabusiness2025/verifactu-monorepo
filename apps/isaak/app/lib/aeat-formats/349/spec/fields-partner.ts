...
export const SPEC_349_PARTNER_XML: string = `<?xml version="1.0" encoding="utf-8" ?>
<odoo>
    <!-- Tipo registro 2 – Registro de clientes: -->
    <record id="aeat_mod349_partner_export_config" model="aeat.model.export.config">
        <field name="name">Mod. 349 - Registro de cliente</field>
        <field name="model_number">349</field>
        <field name="active" eval="False" />
    </record>
    <!--            1           Numérico        Tipo de Registro       Constante = '2' -->
    <record
        id="aeat_mod349_partner_export_line_01"
    ...
    <record
        id="aeat_mod349_partner_export_line_02"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod349_partner_export_line_03"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod349_partner_export_line_04"
        model="aeat.model.export.config.line"
    >
    ...
    <!--            18-75       Blancos          -->
    <record
        id="aeat_mod349_partner_export_line_05"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod349_partner_export_line_06"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod349_partner_export_line_07"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod349_partner_export_line_08"
        model="aeat.model.export.config.line"
    >
    ...
    <record
        id="aeat_mod349_partner_export_line_09"
        model="aeat.model.export.config.line"
    >
    ...
    <!--            147-500     Blancos          -->
    <record
        id="aeat_mod349_partner_export_line_10"
        model="aeat.model.export.config.line"
    >
