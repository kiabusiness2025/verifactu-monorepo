// Auto-generated from fields-main.xml.
// Source: github.com/OCA/l10n-spain (AGPL/LGPL).

export const SPEC_349_MAIN_XML: string = `<?xml version="1.0" encoding="utf-8" ?>
<odoo>
    ...
    <record id="aeat_mod349_main_export_line_10" model="aeat.model.export.config.line">
        ...
        <field name="expression">\${object.statement_type.replace('N', ' ')}</field>
        <field name="export_type">string</field>
    ...
    <record id="aeat_mod349_main_export_line_15" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Número total de operadores intracomunitarios con rectificaciones</field>
    ...
    <record id="aeat_mod349_main_export_line_17" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Indicador cambio periodicidad en la obligación a declarar</field>
    ...
    <record id="aeat_mod349_main_export_line_22" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Exportación modelo 349 - Tipo de Registro 2 – Registro de cliente</field>
    ...
    <record id="aeat_mod349_main_export_line_23" model="aeat.model.export.config.line">
        ...
        <field
            name="name"
        >Exportación modelo 349 - Tipo de Registro 2 – Registro de abono cliente</field>
