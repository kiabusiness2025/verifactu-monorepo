    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 32px rgba(15,23,42,.07);">
        ...
        <tr><td style="padding:32px;">
          ...
          <a href="https://isaak.verifactu.business/fiscal"
          ...
          <p style="margin:0;font-size:13px;color:#94a3b8;line-height:1.5;">
            ...
            <a href="https://isaak.verifactu.business/settings?section=notificaciones" style="color:#2361d8;">ajustes de notificaciones</a>.
          </p>
        </td></tr>
