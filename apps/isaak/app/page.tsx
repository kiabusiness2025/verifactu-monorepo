            ...
            <div className="space-y-4">
              <div className="rounded-[1.5rem] border border-white/70 bg-[linear-gradient(135deg,#081936_0%,#0f2660_45%,#2361d8_100%)] p-6 shadow-[0_35px_90px_-35px_rgba(8,25,54,0.7)]">
                ...
                <h2 className="mt-4 text-3xl font-bold tracking-tight text-white sm:text-4xl">
                  Isaak no cambia de personalidad por la integración que uses.
                </h2>
                <p className="mt-4 max-w-2xl text-sm leading-7 text-white/80 sm:text-base">
                  Puede entrar por Holded hoy y por otras fuentes mañana, pero la experiencia que
                  acompaña, explica y ordena siempre es Isaak.
                </p>
                ...
                <div className="mt-6 grid gap-3 sm:grid-cols-3">
                  <div className="rounded-2xl border border-white/10 bg-white/10 p-4">
                    ...
                    <div className="mt-2 text-sm font-semibold text-white">
                      Prioriza lo importante antes de que sea urgente.
                    </div>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-white/10 p-4">
                    <div className="text-[11px] font-semibold uppercase tracking-[0.16em] text-white/60">
                    ...
                    <div className="mt-2 text-sm font-semibold text-white">
                      Trabaja con señales reales de negocio, no con teoría aislada.
                    </div>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-white/10 p-4">
                    <div className="text-[11px] font-semibold uppercase tracking-[0.16em] text-white/60">
                    ...
                    <div className="mt-2 text-sm font-semibold text-white">
                      Construido para responder mejor a medida que conoce tu operación.
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <div className="mt-1 text-sm leading-6 text-slate-600">
                            La conexión es solo el comienzo. El objetivo de Isaak es darte claridad
                            fiscal y operativa sostenida, no una simple integración para marcar en
                            una checklist.
                          </div>
                        </div>
                      </div>
