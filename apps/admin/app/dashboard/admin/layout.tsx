...
const adminNav = [
  ...
  { label: 'Empresas', href: '/tenants' },
  { label: 'Suscripciones', href: '/subscriptions' },
  { label: 'Correo', href: '/integrations/resend' },
  { label: 'Integraciones', href: '/integrations' },
  { label: 'Usuarios vs Tenants', href: '/operations/integrity' },
  ...
  return (
    <div className="flex gap-6">
      <aside className="hidden w-64 shrink-0 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm lg:block">
        ...
        <div className="text-xs font-semibold uppercase tracking-[0.12em] text-slate-500">Admin</div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <div className="text-[11px] text-rose-700">
                Gestión de usuarios, empresas, suscripciones, integraciones y soporte.
              </div>
            </div>
