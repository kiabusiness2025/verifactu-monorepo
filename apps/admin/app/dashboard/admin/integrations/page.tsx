...
export default function AdminIntegrationsPage() {
  const [integrations, setIntegrations] = useState<Integration[]>([
    ...
    },
    {
      id: 'openai',
      name: 'OpenAI',
      description: 'Asistente Isaak con cuenta de servicio',
      status: 'connected',
    },
    {
      id: 'github',
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-600">Gestiona las conexiones con servicios externos</p>
        </div>
        <button
          onClick={() => {
            setLoading(true);
      ...
      <div className="rounded-xl border-2 border-dashed border-slate-300 bg-slate-50 p-8 text-center">
        ...
        <h3 className="font-semibold text-slate-900 mb-2">Agregar nueva integración</h3>
      ...
      <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
        <div className="flex gap-3">
          ...
          <div className="text-sm">
            <p className="font-semibold text-blue-900 mb-1">Documentación de integraciones</p>
            <p className="text-blue-700 mb-2">
              Aprende cómo configurar y gestionar las integraciones disponibles
            </p>
            <a href="/docs/integrations" className="text-blue-600 hover:text-blue-800 underline">
              Ver guías →
            </a>
          </div>
        </div>
