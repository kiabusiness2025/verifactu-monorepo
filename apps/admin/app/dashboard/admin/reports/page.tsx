...
export default function ReportsPage() {
  ...
  const reportTypes = [
    ...
    {
      title: 'Modelo 390',
      description: 'Declaracin-resumen anual de operaciones con terceros',
      icon: FileText,
      action: 'generate-390',
    },
    {
      title: 'Modelo 303',
      description: 'Declaracin mensual de IVA',
      icon: FileText,
      action: 'generate-303',
    },
    {
    ...
    <main className="space-y-6">
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm space-y-4">
        ...
        <p className="text-sm text-gray-600">
          Enva reportes mensuales automticamente a las empresas registradas
        </p>
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div className="space-y-2 text-sm">
          {[
            ...
            { date: '2 das atrs, 09:45', type: 'Reporte de Clientes', status: 'Descargado' },
          ].map((item, idx) => (
            <div
              key={idx}
