      ...
      <section className="space-y-3">
        ...
        <div className="rounded-xl border border-blue-100 bg-blue-50/60 p-3">
          ...
          <Link
            ...
            className="mt-3 inline-flex h-8 items-center rounded-full bg-[#0b6cfb] px-3 text-xs font-semibold text-white hover:bg-[#095edb]"
          >
            Añadir empresa y activar prueba
          </Link>
        </div>
