...
export default function GlobalError({ error, reset }: Props) {
  return (
    <html lang="es">
      <body>
        <main className="flex min-h-screen items-center justify-center bg-[linear-gradient(180deg,#ffffff_0%,#fff7f7_48%,#ffffff_100%)] px-4 py-10 text-slate-900">
