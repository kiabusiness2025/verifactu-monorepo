        ...
        <table className="w-full">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-sm font-semibold text-gray-700">Código Contable</th>
          ...
          <tbody className="divide-y divide-gray-200">
            {suppliers.map((supplier) => (
              <tr key={supplier.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 text-sm text-gray-600">{supplier.nif || '-'}</td>
                <td className="px-6 py-4 text-sm font-mono text-gray-600">{supplier.accountCode || '-'}</td>
