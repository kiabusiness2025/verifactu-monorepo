...
export function DashboardStats() {
  const stats: Stat[] = [
    ...
    { title: "Estado VeriFactu", value: "Ok", note: "Última actualización hace 5 min", tone: "ok" },
    { title: "AEAT", value: "Sin avisos", note: "Todo al día", tone: "ok" },
    { title: "Bancos", value: "Conciliación 92%", note: "2 movimientos por revisar", tone: "warn" },
