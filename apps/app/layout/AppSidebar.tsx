...
// Items adicionales (futuro: reportes, integraciones, etc.)
...
const AppSidebar: React.FC = () => {
  ...
  const renderMenuItems = (navItems: NavItem[], menuType: 'main' | 'others') => {
    ...
    const filteredItems = navItems.filter((nav) => hasRole(nav.roles));
  ...
  return (
    <aside
      className={`fixed mt-16 flex flex-col lg:mt-0 top-0 px-5 left-0 bg-brand-gradient text-white h-screen transition-all duration-300 ease-in-out z-50 
