...
import { LifeBuoy, Mail, ShieldCheck, MessageSquareText, ExternalLink } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Soporte | Isaak for Holded',
  description:
    'Canales de soporte de Isaak for Holded para usuarios que conectan Holded con ChatGPT y Verifactu.',
};
    ...
    <main className="min-h-screen bg-[linear-gradient(180deg,#ffffff_0%,#fff7f7_45%,#ffffff_100%)] text-slate-900">
      <div className="border-b border-slate-200 bg-white/90 backdrop-blur-sm">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4">
          ...
          <Link href="https://verifactu.business" className="text-sm font-semibold text-slate-600 hover:text-slate-900">
            verifactu.business
          </Link>
        </div>
      </div>
      ...
      <section className="mx-auto max-w-5xl px-4 py-16">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-slate-950">Soporte para Isaak for Holded</h1>
            <p className="max-w-2xl text-lg leading-8 text-slate-600">
              Si estás conectando Holded con ChatGPT y necesitas ayuda, este es el punto de soporte oficial de la app.
              Atendemos dudas de onboarding, errores de conexión y preguntas sobre la experiencia completa de Verifactu.
            </p>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm lg:w-[25rem]">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-600">
              Respondemos en horario laboral. Si la incidencia afecta a onboarding o conexión de Holded, priorizamos la
              revisión para no bloquear la activación de la app.
            </p>
          </div>
        </div>
        ...
        <div className="mt-10 rounded-3xl border border-slate-200 bg-slate-50 p-6">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-600">
            Email de soporte: <a href="mailto:info@verifactu.business" className="font-semibold text-[#ff5460] underline underline-offset-4">info@verifactu.business</a>
          </p>
          <p className="mt-2 text-sm leading-7 text-slate-600">
            También puedes ampliar a la experiencia completa en{' '}
            <Link href="https://verifactu.business" className="font-semibold text-[#ff5460] underline underline-offset-4">
              verifactu.business
            </Link>
            .
          </p>
