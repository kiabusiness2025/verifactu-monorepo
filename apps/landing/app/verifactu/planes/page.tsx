  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      <div className="mx-auto w-full max-w-4xl px-4 py-12 sm:py-16">
        ...
        <p className="mt-6 text-xs font-semibold uppercase tracking-[0.08em] text-blue-600">Calculadora</p>
        <h1 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">Calcula tu precio</h1>
        <p className="mt-4 max-w-3xl text-base leading-7 text-slate-700 sm:text-lg">
          Sin permanencias ni tablas de cuotas fijas. Pagas segun uso real: empresas activas, facturas y movimientos
          bancarios conciliados. 1 mes gratis y aviso antes de renovar.
        </p>

        <div className="mt-8 rounded-2xl border border-slate-200 bg-slate-50 p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-slate-900">Tu precio siempre sale de esta calculadora</h2>
          <p className="mt-2 text-sm text-slate-600">
            Ajusta los controles para ver tu cuota orientativa. El IVA no esta incluido.
          </p>
          <div className="mt-4">
            <PricingCalculator />
          </div>
          <p className="mt-3 text-xs text-slate-500">
            ...
            conciliacion bancaria). No hay cuotas fijas fuera de este calculo. Avisamos antes de renovar para que
            ajustes el plan.
          </p>
        </div>
