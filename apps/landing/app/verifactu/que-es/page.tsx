    ...
    <main className="min-h-screen bg-white text-slate-900">
      <div className="mx-auto w-full max-w-4xl px-4 py-12 sm:py-16">
        ...
        <p className="mt-4 text-base leading-7 text-slate-700 sm:text-lg">
          VeriFactu es el estándar de facturación verificable exigido por la AEAT. Cada factura
          queda sellada con hash y marca temporal para asegurar integridad y trazabilidad. Asi, tus
          cierres quedan listos y auditables sin friccion.
        </p>

        <div className="mt-8 grid gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-5 sm:grid-cols-2">
          <Feature
            title="Trazabilidad automática"
            desc="Cada factura queda sellada con hash y marca temporal."
          />
          <Feature
            title="Integridad anti-manipulación"
            desc="Histórico inmutable: sin sobrescrituras ni borrados."
          />
          <Feature
            title="Auditoría simplificada"
            desc="Exporta registros y evidencias en un clic."
          />
        ...
        <div className="mt-10 space-y-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="text-sm leading-6 text-slate-700">
            Isaak aplica reglas, valida envíos y te avisa si algo se desvía. Combina cumplimiento
            con un panel claro de ventas, gastos y beneficio. Te da contexto rapido para decidir
            cada semana.
          </p>
