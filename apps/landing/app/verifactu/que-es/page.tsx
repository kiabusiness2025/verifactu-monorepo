...
export const metadata = {
  title: "¿Qué es VeriFactu? | Verifactu Business",
  description:
    "VeriFactu es el sistema de facturación verificable que garantiza trazabilidad, auditoría y cumplimiento anti-fraude para autónomos y empresas.",
};
  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      <div className="mx-auto w-full max-w-4xl px-4 py-12 sm:py-16">
        <p className="text-xs font-semibold uppercase tracking-[0.08em] text-blue-600">VeriFactu</p>
        <h1 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">¿Qué es VeriFactu?</h1>
        <p className="mt-4 text-base leading-7 text-slate-700 sm:text-lg">
          VeriFactu es el estándar de facturación verificable que exige la AEAT para garantizar la integridad de tus
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="text-sm text-slate-600">
            ¿Necesitas que te guiemos? Revisa los planes o contáctanos.
          </div>
