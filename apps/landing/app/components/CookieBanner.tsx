    ...
    >
      <div className="mx-auto flex max-w-6xl flex-col gap-3 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:gap-4 sm:px-6">
        <p className="text-sm text-slate-600">
          Utilizamos cookies técnicas para el funcionamiento esencial. Puedes aceptar solo las
          esenciales o todas. Más detalle en{' '}
          <Link
            href="/legal/cookies"
            className="text-[#2361d8] font-semibold hover:text-[#2361d8]"
