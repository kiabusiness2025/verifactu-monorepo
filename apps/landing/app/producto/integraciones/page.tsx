import { ArrowRight, Building, CheckCircle2, Database, Plug } from 'lucide-react';
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-lg text-slate-600">
              Conecta datos financieros, automatiza tareas y centraliza la información en un solo
              lugar. Isaak te ayuda a validar y ordenar el flujo.
            </p>
