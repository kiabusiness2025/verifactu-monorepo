  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-12 space-y-10">
      ...
      <section className="space-y-3">
        ...
        <p className="text-gray-700">
          Consulta también nuestra <Link className="text-blue-600 hover:underline" href="/legal/privacidad">Política de privacidad</Link> y <Link className="text-blue-600 hover:underline" href="/legal/terminos">Términos y condiciones</Link>.
        </p>
      </section>
    </main>
  );
