  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-12 space-y-10">
      <div className="mb-2 text-sm">
        <Link href="/" className="text-blue-700 font-semibold hover:text-blue-800" aria-label="Volver al inicio">â† Volver al inicio</Link>
      </div>
      <header className="space-y-2">
        <p className="text-sm text-gray-500">Ãšltima actualizaciÃ³n: {today}</p>
        <h1 className="text-3xl font-bold text-gray-900">TÃ©rminos y condiciones de uso</h1>
        <p className="text-gray-700">
          Estos tÃ©rminos regulan el acceso y uso de los servicios Verifactu Business ofrecidos a travÃ©s de {" "}
      ...
      <section className="space-y-3">
        ...
        <p className="text-gray-700">
          El uso del servicio implica la aceptaciÃ³n Ã­ntegra de estos tÃ©rminos. Si no estÃ¡s de acuerdo, debes
      ...
      <section className="space-y-3">
        ...
        <p className="text-gray-700">
          Verifactu Business es una plataforma SaaS orientada a la gestiÃ³n y generaciÃ³n de facturas VeriFactu, con
          funcionalidades de autenticaciÃ³n, panel de usuario y servicios asociados.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-gray-700">
          Si existen planes de pago, se publicarÃ¡n las tarifas vigentes y condiciones de facturaciÃ³n. Los impuestos
          aplicables se aÃ±adirÃ¡n segÃºn la normativa. Las facturas se emitirÃ¡n a los datos fiscales que proporciones.
      ...
      <section className="space-y-3">
        ...
        <p className="text-gray-700">
          El software, diseÃ±os y contenidos del servicio son titularidad de {owner.name} o de sus licenciantes.
          Concedes una licencia limitada para operar tus datos dentro de la plataforma con la Ãºnica finalidad de
      ...
      <section className="space-y-3">
        ...
        <p className="text-gray-700">
          ...
          <Link className="text-indigo-600 hover:underline" href="/legal/privacidad">PolÃ­tica de privacidad</Link>.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-gray-700">
          ...
          PodrÃ¡n realizarse mantenimientos programados o urgentes. El soporte se atenderÃ¡ a travÃ©s de {" "}
      ...
      <section className="space-y-3">
        ...
        <p className="text-gray-700">
          El servicio se presta â€œtal cualâ€ dentro de los lÃ­mites legales. No nos hacemos responsables de daÃ±os
          indirectos, lucro cesante o pÃ©rdida de datos derivados del uso de la plataforma, salvo dolo o culpa grave.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-gray-700">
          ...
          de estos tÃ©rminos o por requisitos legales. Algunas obligaciones (confidencialidad, pagos pendientes,
          limitaciÃ³n de responsabilidad) sobrevivirÃ¡n a la terminaciÃ³n.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-gray-700">
          Podemos actualizar estos tÃ©rminos para reflejar mejoras del servicio o cambios normativos. Publicaremos la
          versiÃ³n vigente con su fecha. El uso continuado tras la publicaciÃ³n implica aceptaciÃ³n de las modificaciones.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-gray-700">
          Estos tÃ©rminos se rigen por la legislaciÃ³n espaÃ±ola. Para cualquier conflicto, las partes se someten a los
