  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-slate-50 px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8 text-center">
        <h1 className="text-5xl font-extrabold text-[#2361d8] mb-4">404</h1>
        ...
        <Link href={getLandingUrl()} className="inline-block px-6 py-3 rounded-full bg-[#2361d8] text-white font-semibold shadow transition hover:bg-[#1f55c0]">
          Volver al inicio
        </Link>
      </div>
    </main>
