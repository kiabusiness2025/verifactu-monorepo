    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <section className="py-14">
        <Container>
          ...
          <div className="mx-auto mt-8 max-w-4xl rounded-2xl border border-slate-200 bg-[linear-gradient(145deg,#ffffff_0%,#f8fbff_100%)] p-6 shadow-sm">
            <h2 className="text-xl font-semibold text-[#011c67]">
              Cómo entran los usuarios antes del plan de pago
            </h2>
            <ul className="mt-3 space-y-2 text-sm leading-6 text-slate-600">
              ...
              <li>
                - Acompañamiento en dashboard e Isaak para activar el salto a datos propios en el
                momento correcto.
              </li>
              <li>
                - Prueba de 30 días para crear 1 empresa real y validar el flujo completo con tus
                datos.
              </li>
            </ul>
          ...
          <div className="mx-auto mt-8 flex max-w-3xl flex-col items-center gap-3 sm:flex-row sm:justify-center">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center rounded-full border border-[#2361d8] px-6 py-3 text-sm font-semibold text-[#2361d8] hover:bg-[#2361d8]/10"
            >
              Hablar con el equipo antes de activar
            </Link>
          </div>
        </Container>
      </section>
